        ...
        <div class="grid md:grid-cols-2 gap-10 items-start">
            <div>
                ...
                <ul class="mt-6 space-y-2 text-slate-700">
                    <li>✉️ <?php echo esc_html(get_theme_mod('contact_email', 'editingservices.vn@gmail.com')); ?></li>
                    <li>📞 <?php echo esc_html(get_theme_mod('contact_phone', '+84 949494217')); ?></li>
                    <li>🌐 <?php echo esc_html(get_theme_mod('contact_website', 'www.fotoservices.com')); ?></li>
                </ul>

                <!-- Social Media Icons -->
                <div class="mt-6 flex items-center gap-4">
                    <?php if (get_theme_mod('social_facebook', 'https://www.facebook.com/RE.PhotoServices/')): ?>
                    ...
                    <?php if (get_theme_mod('social_tiktok', 'https://www.tiktok.com/@fotoservices')): ?>
                        <a href="<?php echo esc_url(get_theme_mod('social_tiktok')); ?>"
                           target="_blank"
                           rel="noopener noreferrer"
                           class="text-slate-600 hover:text-indigo-600 transition-colors"
                           aria-label="TikTok">
                    ...
                    <?php if (get_theme_mod('social_instagram', 'https://www.instagram.com/fotoservices/')): ?>
